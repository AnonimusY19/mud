      ...
      child: IntrinsicHeight(
        child: Row(
          children: [
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(listing.title, style: TextStyle(fontSize: 16, fontWeight: FontWeight.w700, color: AppColors.textPrimary)),
            ...
            IconButton(icon: Icon(Icons.edit_outlined, color: AppColors.textGrey), onPressed: onEdit),
